...
import {
  ...
  User, Award, CheckCircle, XCircle, MessageCircle,
  Building, Globe, Briefcase, Users, Target, Shield
} from 'lucide-react';
      ...
      {popup.show && (
        <div className="fixed inset-0 flex items-center justify-center bg-black/50 backdrop-blur-sm z-50 animate-fadeIn">
          <div className="bg-white p-8 rounded-2xl shadow-2xl w-[90%] max-w-md animate-slideUp text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-800 mb-2">{popup.message}</h2>
          </div>
        </div>
      )}
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 bg-orange-500/20 backdrop-blur-sm border border-orange-400/30 px-5 py-2 rounded-full mb-6">
              ...
              <span className="text-sm font-semibold text-orange-300">Get In Touch</span>
            </div>
            ...
            <p className="text-xl md:text-2xl text-gray-300 leading-relaxed max-w-3xl mx-auto">
              Have questions about our cyber security training programs? We're here to help you start your journey to becoming a security professional.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid lg:grid-cols-3 gap-8 mb-12">
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8 hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <span className="text-orange-600 font-semibold">Maharashtra 400014</span>
            </p>
            <a
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8 hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
            ...
            <p className="text-gray-700 mb-4">
              Speak with our admission counselors and get all your questions answered.
            </p>
            <a
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-12">
            ...
            <div className="bg-gradient-to-r from-orange-50 to-white p-6 border-b border-gray-100">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Fill the form and our team will contact you within 24 hours</p>
                </div>
              </div>
            </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      >
                        ...
                        <option value="Ethical Hacking">Ethical Hacking (CEH)</option>
          ...
          <div className="space-y-8">
            <section className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center p-4 bg-orange-50 rounded-xl border border-orange-100">
                  ...
                  <span className="text-orange-600 font-bold">9:00 AM - 7:00 PM</span>
                </div>
                <div className="flex justify-between items-center p-4 bg-orange-50 rounded-xl border border-orange-100">
                  <span className="font-semibold text-gray-900">Saturday</span>
                  <span className="text-orange-600 font-bold">9:00 AM - 5:00 PM</span>
                </div>
            ...
            <section className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl shadow-xl p-8 text-white">
              <h3 className="text-2xl font-bold mb-4">Why Choose SevenMentor?</h3>
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-6 h-6 flex-shrink-0 mt-1" />
                  <div>
                    <h4 className="font-bold text-lg mb-1">Expert Trainers</h4>
                    <p className="text-orange-100 text-sm">Learn from industry professionals with 8+ years of experience</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-6 h-6 flex-shrink-0 mt-1" />
                  <div>
                    <h4 className="font-bold text-lg mb-1">100% Placement Support</h4>
                    <p className="text-orange-100 text-sm">Dedicated placement team to help you land your dream job</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-6 h-6 flex-shrink-0 mt-1" />
                  <div>
                    <h4 className="font-bold text-lg mb-1">Hands-on Training</h4>
                    <p className="text-orange-100 text-sm">Practice with real tools and security platforms</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-6 h-6 flex-shrink-0 mt-1" />
                  <div>
                    <h4 className="font-bold text-lg mb-1">2000+ Students Trained</h4>
                    <p className="text-orange-100 text-sm">Join our community of successful security professionals</p>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
              ...
              <div className="grid grid-cols-2 gap-4">
                <a href="#" className="flex items-center gap-2 text-gray-700 hover:text-orange-600 transition-colors p-3 rounded-lg hover:bg-orange-50">
        ...
        <section className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white rounded-2xl shadow-xl overflow-hidden p-12">
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to Start Your Cyber Security Journey?</h2>
            <p className="text-xl text-gray-300 mb-8">
              Join 2000+ students who have successfully launched their careers in cyber security with SevenMentor
            </p>
